...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  /**
   * Test Main.  It will explore (a) picture(s) 
   */
  public static void main( String args[])
  {
    Picture p = new Picture("engine.jpg");
    Picture smallP = p.scale(.25,.25);
    smallP.write("smallEngine.jpg");
    
    Picture pix = new Picture("smallEngine.jpg");
    pix.explore();
    
    Picture pix2 = new Picture("engine.jpg");
    pix2.explore();
  }
